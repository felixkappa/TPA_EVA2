...
public class RELOJ extends javax.swing.JFrame {
    int contDec,contMin,contSeg;
    public void actualizarCrono(){
    lblDec1.setText("0" + contDec);
    if(contSeg < 10)
    lblSeg1.setText("0" + contSeg);
    else
        lblSeg1.setText("" + contSeg);
    if(contSeg < 10)
    lblMin1.setText("" + contMin);
    }
Runnable runnable = new Runnable(){
    ...
    public void run() {
        while(true){
            ...
            if(contDec == 9){
                contDec = 0;
                //incrementar decima de segundos
